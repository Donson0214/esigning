  ...
  <div class="sign-builder">
    <header class="workflow-header">
      <div class="header-left">
        <button class="btn btn-outline" type="button" @click="handleBack">Back</button>
        <div class="header-title">
          <p class="eyebrow">Sign Builder</p>
          <h2>Prepare your signing flow</h2>
          <p class="subtitle">Choose a path, add recipients, then place fields on the PDF.</p>
        </div>
      </div>
      <div class="stepper">
        <div
      ...
      <div class="choice-grid">
        <button class="choice-card" type="button" @click="selectSigningIntent('send')">
          ...
          <div class="choice-copy">
            ...
            <p>Invite recipients, assign fields, and track each signature step.</p>
          </div>
          <span class="choice-cta">Start sending</span>
        </button>
        <button class="choice-card" type="button" @click="selectSigningIntent('self')">
          ...
          <div class="choice-copy">
            <h3>Sign yourself</h3>
            <p>Upload a PDF and sign immediately with your profile details.</p>
          </div>
          <span class="choice-cta">Sign now</span>
        </button>
      </div>
    </section>
